...
Route::get('/admin/add-categories', 'CategoryController@create')->name('admin.add-categories');
Route::post('/admin/store-categories', 'CategoryController@store')->name('admin.store-categories');
Route::get('/admin/get-categories', 'CategoryController@index')->name('admin.get-categories');
//orders routes
